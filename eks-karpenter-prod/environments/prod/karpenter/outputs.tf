...
# Values needed for Helm install and Kubernetes manifests (node-class, node-pool)
###############################################################################
...
output "interruption_queue_name" {
  description = "SQS interruption queue name — paste into karpenter-helm-values.yaml"
  value       = module.karpenter.queue_name
}

output "node_iam_role_arn" {
  description = "Node IAM role ARN (passed through from EKS layer)"
